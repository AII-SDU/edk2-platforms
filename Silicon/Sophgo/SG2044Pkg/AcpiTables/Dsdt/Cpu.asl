...
Scope(_SB)
{
  ...
  Device (CL00) {   // Cluster 0
    ...
    Device (CP01) { // SG2044 Cluster 0, core 1
      Name (_HID, "ACPI0007")
      Name (_UID, 1)
      Name (_STA, 0xF)
    ...
    Device (CP02) { // SG2044 Cluster 0, core 2
      Name (_HID, "ACPI0007")
      Name (_UID, 2)
      Name (_STA, 0xF)
    ...
    Device (CP03) { // SG2044 Cluster 0, core 3
      Name (_HID, "ACPI0007")
      Name (_UID, 3)
      Name (_STA, 0xF)
  ...
  Device (CL01) {   // Cluster 1
    ...
    Device (CP05) { // SG2044 Cluster 1, core 5
      Name (_HID, "ACPI0007")
      Name (_UID, 5)
      Name (_STA, 0xF)
    ...
    Device (CP06) { // SG2044 Cluster 1, core 6
      Name (_HID, "ACPI0007")
      Name (_UID, 6)
      Name (_STA, 0xF)
    ...
    Device (CP07) { // SG2044 Cluster 1, core 7
      Name (_HID, "ACPI0007")
      Name (_UID, 7)
      Name (_STA, 0xF)
  ...
  Device (CL02) {   // Cluster 2
    ...
    Device (CP09) { // SG2044 Cluster 2, core 9
      Name (_HID, "ACPI0007")
      Name (_UID, 9)
      Name (_STA, 0xF)
    ...
    Device (CP10) { // SG2044 Cluster 2, core 10
      Name (_HID, "ACPI0007")
      Name (_UID, 10)
      Name (_STA, 0xF)
    ...
    Device (CP11) { // SG2044 Cluster 2, core 11
      Name (_HID, "ACPI0007")
      Name (_UID, 11)
      Name (_STA, 0xF)
  ...
  Device (CL03) {   // Cluster 3
    ...
    Device (CP13) { // SG2044 Cluster 3, core 13
      Name (_HID, "ACPI0007")
      Name (_UID, 13)
      Name (_STA, 0xF)
    ...
    Device (CP14) { // SG2044 Cluster 3, core 14
      Name (_HID, "ACPI0007")
      Name (_UID, 14)
      Name (_STA, 0xF)
    ...
    Device (CP15) { // SG2044 Cluster 3, core 15
      Name (_HID, "ACPI0007")
      Name (_UID, 15)
      Name (_STA, 0xF)
  ...
  Device (CL04) {   // Cluster 4
    ...
    Device (CP17) { // SG2044 Cluster 4, core 17
      Name (_HID, "ACPI0007")
      Name (_UID, 17)
      Name (_STA, 0xF)
    ...
    Device (CP18) { // SG2044 Cluster 4, core 18
      Name (_HID, "ACPI0007")
      Name (_UID, 18)
      Name (_STA, 0xF)
    ...
    Device (CP19) { // SG2044 Cluster 4, core 19
      Name (_HID, "ACPI0007")
      Name (_UID, 19)
      Name (_STA, 0xF)
  ...
  Device (CL05) {   // Cluster 5
    ...
    Device (CP21) { // SG2044 Cluster 5, core 21
      Name (_HID, "ACPI0007")
      Name (_UID, 21)
      Name (_STA, 0xF)
    ...
    Device (CP22) { // SG2044 Cluster 5, core 22
      Name (_HID, "ACPI0007")
      Name (_UID, 22)
      Name (_STA, 0xF)
    ...
    Device (CP23) { // SG2044 Cluster 5, core 23
      Name (_HID, "ACPI0007")
      Name (_UID, 23)
      Name (_STA, 0xF)
  ...
  Device (CL06) {   // Cluster 6
    ...
    Device (CP25) { // SG2044 Cluster 6, core 25
      Name (_HID, "ACPI0007")
      Name (_UID, 25)
      Name (_STA, 0xF)
    ...
    Device (CP26) { // SG2044 Cluster 6, core 26
      Name (_HID, "ACPI0007")
      Name (_UID, 26)
      Name (_STA, 0xF)
    ...
    Device (CP27) { // SG2044 Cluster 6, core 27
      Name (_HID, "ACPI0007")
      Name (_UID, 27)
      Name (_STA, 0xF)
  ...
  Device (CL07) {   // Cluster 7
    ...
    Device (CP29) { // SG2044 Cluster 7, core 29
      Name (_HID, "ACPI0007")
      Name (_UID, 29)
      Name (_STA, 0xF)
    ...
    Device (CP30) { // SG2044 Cluster 7, core 30
      Name (_HID, "ACPI0007")
      Name (_UID, 30)
      Name (_STA, 0xF)
    ...
    Device (CP31) { // SG2044 Cluster 7, core 31
      Name (_HID, "ACPI0007")
      Name (_UID, 31)
      Name (_STA, 0xF)
  ...
  Device (CL08) {   // Cluster 8
    ...
    Device (CP33) { // SG2044 Cluster 8, core 33
      Name (_HID, "ACPI0007")
      Name (_UID, 33)
      Name (_STA, 0xF)
    ...
    Device (CP34) { // SG2044 Cluster 8, core 34
      Name (_HID, "ACPI0007")
      Name (_UID, 34)
      Name (_STA, 0xF)
    ...
    Device (CP35) { // SG2044 Cluster 8, core 35
      Name (_HID, "ACPI0007")
      Name (_UID, 35)
      Name (_STA, 0xF)
  ...
  Device (CL09) {   // Cluster 9
    ...
    Device (CP37) { // SG2044 Cluster 9, core 37
      Name (_HID, "ACPI0007")
      Name (_UID, 37)
      Name (_STA, 0xF)
    ...
    Device (CP38) { // SG2044 Cluster 9, core 38
      Name (_HID, "ACPI0007")
      Name (_UID, 38)
      Name (_STA, 0xF)
    ...
    Device (CP39) { // SG2044 Cluster 9, core 39
      Name (_HID, "ACPI0007")
      Name (_UID, 39)
      Name (_STA, 0xF)
  ...
  Device (CL10) {   // Cluster 10
    ...
    Device (CP41) { // SG2044 Cluster 10, core 41
      Name (_HID, "ACPI0007")
      Name (_UID, 41)
      Name (_STA, 0xF)
    ...
    Device (CP42) { // SG2044 Cluster 10, core 42
      Name (_HID, "ACPI0007")
      Name (_UID, 42)
      Name (_STA, 0xF)
    ...
    Device (CP43) { // SG2044 Cluster 10, core 43
      Name (_HID, "ACPI0007")
      Name (_UID, 43)
      Name (_STA, 0xF)
  ...
  Device (CL11) {   // Cluster 11
    ...
    Device (CP45) { // SG2044 Cluster 11, core 45
      Name (_HID, "ACPI0007")
      Name (_UID, 45)
      Name (_STA, 0xF)
    ...
    Device (CP46) { // SG2044 Cluster 11, core 46
      Name (_HID, "ACPI0007")
      Name (_UID, 46)
      Name (_STA, 0xF)
    ...
    Device (CP47) { // SG2044 Cluster 0, core 47
      Name (_HID, "ACPI0007")
      Name (_UID, 47)
      Name (_STA, 0xF)
  ...
  Device (CL12) {   // Cluster 12
    ...
    Device (CP49) { // SG2044 Cluster 12, core 49
      Name (_HID, "ACPI0007")
      Name (_UID, 49)
      Name (_STA, 0xF)
    ...
    Device (CP50) { // SG2044 Cluster 12, core 50
      Name (_HID, "ACPI0007")
      Name (_UID, 50)
      Name (_STA, 0xF)
    ...
    Device (CP51) { // SG2044 Cluster 12, core 51
      Name (_HID, "ACPI0007")
      Name (_UID, 51)
      Name (_STA, 0xF)
  ...
  Device (CL13) {   // Cluster 13
    ...
    Device (CP53) { // SG2044 Cluster 13, core 53
      Name (_HID, "ACPI0007")
      Name (_UID, 53)
      Name (_STA, 0xF)
    ...
    Device (CP54) { // SG2044 Cluster 13, core 54
      Name (_HID, "ACPI0007")
      Name (_UID, 54)
      Name (_STA, 0xF)
    ...
    Device (CP55) { // SG2044 Cluster 13, core 55
      Name (_HID, "ACPI0007")
      Name (_UID, 55)
      Name (_STA, 0xF)
  ...
  Device (CL14) {   // Cluster 14
    ...
    Device (CP57) { // SG2044 Cluster 14, core 57
      Name (_HID, "ACPI0007")
      Name (_UID, 57)
      Name (_STA, 0xF)
    ...
    Device (CP58) { // SG2044 Cluster 14, core 58
      Name (_HID, "ACPI0007")
      Name (_UID, 58)
      Name (_STA, 0xF)
    ...
    Device (CP59) { // SG2044 Cluster 14, core 59
      Name (_HID, "ACPI0007")
      Name (_UID, 59)
      Name (_STA, 0xF)
  ...
  Device (CL15) {   // Cluster 15
    ...
    Device (CP61) { // SG2044 Cluster 15, core 61
      Name (_HID, "ACPI0007")
      Name (_UID, 61)
      Name (_STA, 0xF)
    ...
    Device (CP62) { // SG2044 Cluster 15, core 62
      Name (_HID, "ACPI0007")
      Name (_UID, 62)
      Name (_STA, 0xF)
    ...
    Device (CP63) { // SG2044 Cluster 15, core 63
      Name (_HID, "ACPI0007")
      Name (_UID, 63)
      Name (_STA, 0xF)

  ...
  )
{
  ...
  return PciSegmentRead (Address, 8);
}
  ...
  )
{
  ...
  return PciSegmentWrite (Address, Value, 8);
}
  ...
  )
{
  ...
  return PciSegmentRead (Address, 16);
}
  ...
  )
{
  ...
  return PciSegmentWrite (Address, Value, 16);
}
  ...
  )
{
  ...
  return PciSegmentRead (Address, 32);
}
  ...
  )
{
  ...
  return PciSegmentWrite (Address, Value, 32);
}
